...
class UpdateNctu extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'update:nctu';
     ...
     * @var string
     */
    protected $description = 'Update NCTU classes information';
    ...
    public function handle()
    {
        ...
        $this->info('Update NCTU classes finished');
    }
